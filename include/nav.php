...
<div class="sous-liens">
	...
	<a href="portfolio.php#section2" class="lien2-2"><i class="fa fa-2x fa-object-group"></i></a>
	<a href="portfolio.php#section3" class="lien2-3"><i class="fa fa-2x fa-pencil"></i></a>
	<a href="portfolio.php#section4" class="lien2-4"><i class="fa fa-2x fa-picture-o"></i></a>
</div>
...
<div class="bulle bulle_2-2"><?php echo $_GET["lang"] == "fr" ? "Design graphique" : ($_GET["lang"] == "en" ? "Graphic design" : ""); ?></div>
<div class="bulle bulle_2-3"><?php echo $_GET["lang"] == "fr" ? "Illustrations" : ($_GET["lang"] == "en" ? "Illustrations" : ""); ?></div>
<div class="bulle bulle_2-4"><?php echo $_GET["lang"] == "fr" ? "Autres" : ($_GET["lang"] == "en" ? "Others" : ""); ?></div>
...
<div class="sous-liens-mobile">
	...
	<a href="portfolio.php#section2" class="sous-lien-mobile lien2-2-mobile"><i class="fa fa-object-group"></i></a>
	<a href="portfolio.php#section3" class="sous-lien-mobile lien2-3-mobile"><i class="fa fa-pencil"></i></a>
	<a href="portfolio.php#section4" class="sous-lien-mobile lien2-4-mobile"><i class="fa fa-picture-o"></i></a>
</div>
...
<div class="bulle-mobile bulle_2-2-mobile"><?php echo $_GET["lang"] == "fr" ? "Design graphique" : ($_GET["lang"] == "en" ? "Graphic design" : ""); ?></div>
<div class="bulle-mobile bulle_2-3-mobile"><?php echo $_GET["lang"] == "fr" ? "Illustrations" : ($_GET["lang"] == "en" ? "Illustrations" : ""); ?></div>
<div class="bulle-mobile bulle_2-4-mobile"><?php echo $_GET["lang"] == "fr" ? "Autres" : ($_GET["lang"] == "en" ? "Others" : ""); ?></div>
